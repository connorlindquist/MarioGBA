...
OFILES = game.o game_over.o main.o mario.o myLib.o start_screen.o font.o coin.o bomb.o mushroom.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = font.h game.h game_over.h mario.h myLib.h start_screen.h font.h coin.h bomb.h mushroom.h
